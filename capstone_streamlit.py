...
"""
capstone_streamlit.py — https://studybuddy-n8oy9cv9bal2cmybmmi6ab.streamlit.app/ Agent
...
st.set_page_config(page_title="https://studybuddy-n8oy9cv9bal2cmybmmi6ab.streamlit.app/", page_icon="🤖", layout="centered")
st.title("🤖 https://studybuddy-n8oy9cv9bal2cmybmmi6ab.streamlit.app/")
st.caption("An AI-powered study assistant that answers academic questions using a knowledge base, tools, and memory.")
...
with st.sidebar:
    st.header("About")
    st.write("An AI-powered study assistant that answers academic questions using a knowledge base, tools, and memory.")
    st.write(f"Session: {st.session_state.thread_id}")
    st.divider()
    st.write("**Topics covered:**")
    for t in ['Normalization in DBMS', 'ER Model', 'SQL Basics', 'LSTM', 'CNN', 'Hidden Markov Model', 'Hill Climbing', 'TCP vs UDP', 'OSI Model', 'K-Means Clustering']:
        st.write(f"• {t}")
